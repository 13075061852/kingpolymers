...
function fluentScrewOptions(source,name,from=null){
 ...
 return {source,label:ComponentModels.model(c).label,html:ComponentModels.symbol(c,spec(),{id:FluentDrag.nextId(),thumbnail:true,presentation:moving?'installed':'catalog'}),
